...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animatorShrinkX = ObjectAnimator.ofFloat(target, "scaleX", 2f, 1f);
        ObjectAnimator animatorShrinkY = ObjectAnimator.ofFloat(target, "scaleY", 2f, 1f);
        animatorShrinkX.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animatorShrinkX.setRepeatCount(ObjectAnimator.INFINITE);
        animatorShrinkX.setRepeatMode(ObjectAnimator.REVERSE);
        animatorShrinkY.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animatorShrinkY.setRepeatCount(ObjectAnimator.INFINITE);
        animatorShrinkY.setRepeatMode(ObjectAnimator.REVERSE);
        ...
        animatorSet.playTogether(animator1, animatorAlpha, animatorShrinkX, animatorShrinkY);
        animatorSet.start();
    }
}
